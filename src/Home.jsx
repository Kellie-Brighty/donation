...
import EthDonation from "./components/EthDonation";
...
const handleCheckout = async () => {
  try {
    const response = await fetch(
      "https://admirable-froyo-137013.netlify.app/api",
      {
        method: "POST",
        headers: {
    ...
    <section className=" bg-gray-100 w-screen pb-18">
      ...
      <div className="md:flex justify-between w-full gap-4 px-6">
        ...
        <div className="md:w-1/3 pt-10">
          ...
          {/* ETH Donation Component */}
          <EthDonation />

          <div className="mt-10 mb-10">
            <h4 className="font-aleo text-xl font-semibold mb-3">
              Other Donation Options
            </h4>

            {/* Bitcoin Donation Option */}
            <div className="mb-6">
              <h5 className="text-md font-medium mb-2">Bitcoin</h5>
              <div className="gap-1 flex">
                <p className="text-[12px]">
                  bc1q846lwf96hguygclxs5q867f87p9ps94t33sst9{" "}
                </p>
                <span>
                  <IoCopy
                    onClick={() => {
            ...
            <p
              className="font-varela text-xl cursor-pointer bg-gray-500 text-white border-2 rounded-3xl w-fit px-20 mt-6 py-1 mx-auto"
